...
public class ContO
{
            ...
            while ((line = dataInputStream.readLine()) != null) {
                ...
                if (this.npl < 210) {
                    ...
                    if (n != 0) {
                        ...
                        if (string.startsWith("p(")) {
                            array3[n3] = (int)(this.getvalue("p", string, 0) * n4 * n5 * array2[0]);
                            array4[n3] = (int)(this.getvalue("p", string, 1) * n4 * array2[1]);
                            array5[n3] = (int)(this.getvalue("p", string, 2) * n4 * array2[2]);
                            final int maxR = (int)Math.sqrt(array3[n3] * array3[n3] + array4[n3] * array4[n3] + array5[n3] * array5[n3]);
                            if (maxR > this.maxR) {
                                this.maxR = maxR;
                            }
                            ++n3;
                ...
                if (string.startsWith("ScaleX(")) {
                    array2[0] = this.getvalue("ScaleX", string, 0) / 100.0f;
                }
                if (string.startsWith("ScaleY(")) {
                    array2[1] = this.getvalue("ScaleY", string, 0) / 100.0f;
                }
        ...
        if (this.m.loadnew) {
            ...
            for (int n11 = 0; n11 < this.npl; ++n11) {
                ...
                if (array[n11] == 1) {
                    ...
                    if (n21 != 0) {
                        final int[] array7 = new int[this.p[n11].n];
    ...
    public ContO(final int n, final int n2, final int n3, final Medium m, final Trackers t, final int x, final int z, final int y) {
        ...
        for (int n23 = 0; n23 < 4; ++n23) {
            ...
            if (n23 == 0) {
                ...
                this.t.zy[this.t.nt] = (int)(Math.atan(this.t.rady[this.t.nt] / (double)this.t.radz[this.t.nt]) / 0.017453292519943295);
            ...
            if (n23 == 1) {
                ...
                this.t.xy[this.t.nt] = (int)(Math.atan(this.t.rady[this.t.nt] / (double)this.t.radx[this.t.nt]) / 0.017453292519943295);
                ...
                if (n4 > 2) {
                    for (int n5 = 0; n5 < 4; ++n5) {
                        ...
                        if (this.t.zy[n3] != 0) {
                            ...
                            final int n6 = n5;
                            array4[n6] += (int)((array3[n5] - (this.t.z[n3] - this.m.z - this.t.radz[n3])) * this.m.sin(this.t.zy[n3]) / this.m.sin(90 - this.t.zy[n3]) - this.t.radz[n3] * this.m.sin(this.t.zy[n3]) / this.m.sin(90 - this.t.zy[n3]));
                        }
                        if (this.t.xy[n3] != 0) {
                            final int[] array5 = array2;
                            final int n7 = n5;
                            array5[n7] += (int)((array[n5] - (this.t.x[n3] - this.m.x - this.t.radx[n3])) * this.m.sin(this.t.xy[n3]) / this.m.sin(90 - this.t.xy[n3]) - this.t.radx[n3] * this.m.sin(this.t.xy[n3]) / this.m.sin(90 - this.t.xy[n3]));
                        }
                    }
                    r = (int)((float)this.t.c[n3][0] / 1.5);
                    g = (int)((float)this.t.c[n3][1] / 1.5);
                    b = (int)((float)this.t.c[n3][2] / 1.5);
                    break;
                }
            }
        }
    ...
    public void fixit(final Graphics2D graphics2D) {
        ...
        if ((this.fcnt == 1 || this.fcnt > 2) && this.fcnt != 9) {
            ...
            final int n3 = (int)(Math.sqrt(py) / 1.5);
            if (abs < n3) {
                abs = n3;
            }
            if (abs2 < n3) {
            ...
            final int n4 = this.m.cx + (int)((this.x - this.m.x - this.m.cx) * this.m.cos(this.m.xz) - (this.z - this.m.z - this.m.cz) * this.m.sin(this.m.xz));
            final int n5 = this.m.cz + (int)((this.x - this.m.x - this.m.cx) * this.m.sin(this.m.xz) + (this.z - this.m.z - this.m.cz) * this.m.cos(this.m.xz));
            final int n6 = this.m.cy + (int)((this.y - this.m.y - this.m.cy) * this.m.cos(this.m.zy) - (n5 - this.m.cz) * this.m.sin(this.m.zy));
            final int n7 = this.m.cz + (int)((this.y - this.m.y - this.m.cy) * this.m.sin(this.m.zy) + (n5 - this.m.cz) * this.m.cos(this.m.zy));
            ...
            array2[1] = this.ys((int)(n6 + abs2 / 1.92 + this.m.random() * (abs2 / 5.67)), n7);
            array[2] = this.xs((int)(n4 - abs / 1.92 - this.m.random() * (abs / 5.67)), n7);
            array2[2] = this.ys((int)(n6 + abs2 / 0.8 + this.m.random() * (abs2 / 2.4)), n7);
            array[3] = this.xs((int)(n4 + abs / 1.92 + this.m.random() * (abs / 5.67)), n7);
            array2[3] = this.ys((int)(n6 + abs2 / 0.8 + this.m.random() * (abs2 / 2.4)), n7);
            array[4] = this.xs((int)(n4 + abs / 0.8 + this.m.random() * (abs / 2.4)), n7);
            array2[4] = this.ys((int)(n6 + abs2 / 1.92 + this.m.random() * (abs2 / 5.67)), n7);
            array[5] = this.xs((int)(n4 + abs / 0.8 + this.m.random() * (abs / 2.4)), n7);
            array2[5] = this.ys((int)(n6 - abs2 / 1.92 - this.m.random() * (abs2 / 5.67)), n7);
            array[6] = this.xs((int)(n4 + abs / 1.92 + this.m.random() * (abs / 5.67)), n7);
            array2[6] = this.ys((int)(n6 - abs2 / 0.8 - this.m.random() * (abs2 / 2.4)), n7);
            array[7] = this.xs((int)(n4 - abs / 1.92 - this.m.random() * (abs / 5.67)), n7);
            array2[7] = this.ys((int)(n6 - abs2 / 0.8 - this.m.random() * (abs2 / 2.4)), n7);
            if (this.fcnt == 3) {
            ...
            int r2 = (int)(191.0f + 191.0f * (this.m.snap[0] / 350.0f));
            if (r2 > 255) {
                r2 = 255;
            }
            if (r2 < 0) {
            ...
            int g2 = (int)(232.0f + 232.0f * (this.m.snap[1] / 350.0f));
            if (g2 > 255) {
                g2 = 255;
            }
            if (g2 < 0) {
            ...
            int b2 = (int)(255.0f + 255.0f * (this.m.snap[2] / 350.0f));
            if (b2 > 255) {
                b2 = 255;
            }
            if (b2 < 0) {
            ...
            array[0] = this.xs((int)(n4 - abs - this.m.random() * (abs / 4)), n7);
            array2[0] = this.ys((int)(n6 - abs2 / 2.4 - this.m.random() * (abs2 / 9.6)), n7);
            array[1] = this.xs((int)(n4 - abs - this.m.random() * (abs / 4)), n7);
            array2[1] = this.ys((int)(n6 + abs2 / 2.4 + this.m.random() * (abs2 / 9.6)), n7);
            array[2] = this.xs((int)(n4 - abs / 2.4 - this.m.random() * (abs / 9.6)), n7);
            array2[2] = this.ys((int)(n6 + abs2 + this.m.random() * (abs2 / 4)), n7);
            array[3] = this.xs((int)(n4 + abs / 2.4 + this.m.random() * (abs / 9.6)), n7);
            array2[3] = this.ys((int)(n6 + abs2 + this.m.random() * (abs2 / 4)), n7);
            array[4] = this.xs((int)(n4 + abs + this.m.random() * (abs / 4)), n7);
            array2[4] = this.ys((int)(n6 + abs2 / 2.4 + this.m.random() * (abs2 / 9.6)), n7);
            array[5] = this.xs((int)(n4 + abs + this.m.random() * (abs / 4)), n7);
            array2[5] = this.ys((int)(n6 - abs2 / 2.4 - this.m.random() * (abs2 / 9.6)), n7);
            array[6] = this.xs((int)(n4 + abs / 2.4 + this.m.random() * (abs / 9.6)), n7);
            array2[6] = this.ys((int)(n6 - abs2 - this.m.random() * (abs2 / 4)), n7);
            array[7] = this.xs((int)(n4 - abs / 2.4 - this.m.random() * (abs / 9.6)), n7);
            array2[7] = this.ys((int)(n6 - abs2 - this.m.random() * (abs2 / 4)), n7);
            int r3 = (int)(213.0f + 213.0f * (this.m.snap[0] / 350.0f));
            if (r3 > 255) {
                r3 = 255;
            }
            if (r3 < 0) {
            ...
            int g3 = (int)(239.0f + 239.0f * (this.m.snap[1] / 350.0f));
            if (g3 > 255) {
                g3 = 255;
            }
            if (g3 < 0) {
            ...
            int b3 = (int)(255.0f + 255.0f * (this.m.snap[2] / 350.0f));
            if (b3 > 255) {
                b3 = 255;
            }
            if (b3 < 0) {
    ...
    public void electrify(final Graphics2D graphics2D) {
        for (int i = 0; i < 4; ++i) {
            ...
            if (b) {
                ...
                int b2 = (int)(255.0f + 255.0f * (this.m.snap[2] / 500.0f));
                if (b2 > 255) {
                    b2 = 255;
                }
                if (b2 < 0) {
                ...
                int r = (n9 * 2 + 214 * (this.elc[i] - 1)) / (this.elc[i] + 1);
                int g = (n10 * 2 + 236 * (this.elc[i] - 1)) / (this.elc[i] + 1);
                if (this.m.trk == 1) {
                    r = 255;
                    g = 128;
                    b2 = 0;
                ...
                if (array3[0] < 4000) {
                    int r2 = (int)(150.0f + 150.0f * (this.m.snap[0] / 500.0f));
                    if (r2 > 255) {
                        r2 = 255;
                    }
                    if (r2 < 0) {
                    ...
                    int g2 = (int)(227.0f + 227.0f * (this.m.snap[1] / 500.0f));
                    if (g2 > 255) {
                        g2 = 255;
                    }
                    if (g2 < 0) {
                    ...
                    int b3 = (int)(255.0f + 255.0f * (this.m.snap[2] / 500.0f));
                    if (b3 > 255) {
                        b3 = 255;
                    }
                    if (b3 < 0) {
    ...
    public void pdust(final int n, final Graphics2D graphics2D, final boolean b) {
        ...
        if ((b && this.sav[n] > this.dist) || (!b && this.sav[n] <= this.dist)) {
            ...
            if (b3) {
                int r = this.srgb[n][0];
                int g = this.srgb[n][1];
                int b4 = this.srgb[n][2];
                for (int n19 = 0; n19 < 16; ++n19) {
                    if (this.sav[n] > this.m.fade[n19]) {
                        r = (r * this.m.fogd + this.m.cfade[0]) / (this.m.fogd + 1);
                        g = (g * this.m.fogd + this.m.cfade[1]) / (this.m.fogd + 1);
                        b4 = (b4 * this.m.fogd + this.m.cfade[2]) / (this.m.fogd + 1);
                    }
                }
                graphics2D.setColor(new Color(r, g, b4));
    ...
    public void dsprk(final Graphics2D graphics2D, final boolean b) {
        ...
        for (int j = 0; j < 100; ++j) {
            if (this.rtg[j] != 0 && ((this.rbef[j] && b) || (!this.rbef[j] && !b))) {
                ...
                if (this.rtg[j] != 0) {
                    int r = 255;
                    int g = 197 - 30 * this.rtg[j];
                    int b3 = 0;
                    for (int k = 0; k < 16; ++k) {
                        if (n13 > this.m.fade[k]) {
                            r = (r * this.m.fogd + this.m.cfade[0]) / (this.m.fogd + 1);
                            g = (g * this.m.fogd + this.m.cfade[1]) / (this.m.fogd + 1);
                            b3 = (b3 * this.m.fogd + this.m.cfade[2]) / (this.m.fogd + 1);
                        }
                    }
                    graphics2D.setColor(new Color(r, g, b3));
