...
public class Channel
{
    ...
    public void row(final Note note) {
        ...
        switch (this.noteEffect) {
            ...
            case 21: {
                final int n2 = this.noteParam & 0xFF;
                this.panEnvTick = n2;
                this.volEnvTick = n2;
                break;
            }
    ...
    private void retrigVolSlide() {
        if (this.retrigCount >= this.retrigTicks) {
            final int retrigCount = 0;
            this.sampleFra = retrigCount;
            this.sampleIdx = retrigCount;
            this.retrigCount = retrigCount;
    ...
    private void trigger() {
        if (this.noteIns > 0 && this.noteIns <= this.module.numInstruments) {
            ...
            final int sampleOffset = 0;
            this.panEnvTick = sampleOffset;
            this.volEnvTick = sampleOffset;
