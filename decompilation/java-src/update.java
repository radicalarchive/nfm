...
public class update extends Applet implements Runnable
{
    ...
    public void run() {
        ...
        while (i == 0) {
            ...
            final int n4 = this.ftm.stringWidth("http://multiplayer.needformadness.com/development.html") + 30;
            ...
            if (Madness.updateon == 3) {
                ...
                final int n5 = 400 - this.ftm.stringWidth("Close updater to finish >") / 2;
                final int n6 = this.ftm.stringWidth("Close updater to finish >") + n5;
                this.rd.drawLine(n5, 167, n6, 167);
                if (this.xm > n5 && this.xm < n6 && this.ym > 150 && this.ym < 169) {
                    n3 = 12;
                    if (this.moused) {
