...
public class Smenu
{
    ...
    public void add(final Graphics2D graphics2D, String str) {
    ...
    public void select(final String anObject) {
        for (int i = 0; i < this.no; ++i) {
            if (this.opts[i].equals(anObject)) {
                this.sel = i;
                break;
            }
        }
                ...
                if (!b2) {
                    ...
                    if (this.y + 23 + n5 > n3) {
                        ...
                        if (this.onsc) {
                            ...
                            this.scro = -(int)(this.scra * ((this.no * (this.ftm.getHeight() + 2) - scra - this.ftm.getHeight() / 2) / (float)scra));
                        }
                    }
                    for (int i = 0; i < this.no; ++i) {
                    ...
                    if (this.y - n5 < 0) {
                        ...
                        if (this.onsc) {
                            ...
                            this.scro = (int)(this.scra * ((this.no * (this.ftm.getHeight() + 2) - scra2 - this.ftm.getHeight() / 2) / (float)scra2));
                        }
                    }
