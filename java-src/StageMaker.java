...
public class StageMaker extends Applet implements Runnable
{
    ...
    public void run() {
        ...
        while (!this.exwist) {
            ...
            if (this.tab == 0) {
                ...
                this.rd.drawString(str, 400 - this.ftm.stringWidth(str) / 2, 500);
                if (this.mouseon != 2) {
                    this.rd.setColor(new Color(0, 64, 128));
                }
                else {
                ...
                this.rd.drawLine(400 - this.ftm.stringWidth(str) / 2, 501, 400 + this.ftm.stringWidth(str) / 2, 501);
                if (this.mouseon == 2) {
                    if (this.mouses == -1) {
                        this.openhlink();
                    }
                ...
                this.rd.setColor(new Color(0, 128, 255));
                final String str2 = "http://www.needformadness.com/developer/help.html";
                this.rd.drawString(str2, 400 - this.ftm.stringWidth(str2) / 2, 500 + n);
                if (this.mouseon != 1) {
                    this.rd.setColor(new Color(0, 64, 128));
                }
                else {
                ...
                this.rd.drawLine(400 - this.ftm.stringWidth(str2) / 2, 501 + n, 400 + this.ftm.stringWidth(str2) / 2, 501 + n);
                if (this.mouseon == 1) {
                    if (this.mouses == -1) {
                        this.openlink();
                    }
                ...
                if (this.dtab == 2) {
                    ...
                    for (int n81 = 0; n81 < 3; ++n81) {
                        ...
                        for (int n82 = 0; n82 < 150; ++n82) {
                            this.rd.setColor(Color.getHSBColor((float)((float)n82 * 0.006667), 1.0f, 1.0f));
                        ...
                        for (int n84 = 0; n84 < 150; ++n84) {
                            this.rd.setColor(Color.getHSBColor(this.hsb[n81][0], 0.0f + (float)((float)n84 * 0.001667), this.hsb[n81][1]));
                    ...
                    for (int n136 = 0; n136 < this.nms; ++n136) {
                        ...
                        if (this.pubt[n136] == -1) {
                            ...
                            if (this.nad[n136] <= 1) {
                                ...
                                String s = "[ " + this.mystages[n136] + " ]  has been added by the following players to their accounts:     \n\n";
                                int n137 = 0;
                                        ...
                                        try {
                                            ...
                                            Label_41300: {
                                                if (nextEntry != null) {
                                                    ...
                                                    final byte[] array33 = new byte[intValue];
                                                    int off = 0;
                                                    while (intValue > 0) {
                                                        final int read3 = zipInputStream.read(array33, off, intValue);
                                                        off += read3;
                                                        intValue -= read3;
                                                    }
                                                    final String string3 = new String(array33) + "\n";
                                                    String str3 = "";
                                                    int n143 = 0;
                                                    int endIndex = string3.indexOf("\n", 0);
                                                    while (true) {
                                                        while (endIndex != -1) {
                                                            if (n143 >= string3.length()) {
                                                                final String string4 = str3.trim() + "\r\n\r\n";
                                                                ...
                                                                if (!getstring.equals("")) {
                                                                    try {
                                                                        ...
                                                                        if (n139 == 0) {
                                                                            ...
                                                                            final byte[] array34 = new byte[contentLength2];
                                                                            dataInputStream2.readFully(array34);
                                                                            dataInputStream2.close();
                                                                            final FileOutputStream fileOutputStream2 = new FileOutputStream(file8);
                                                                            fileOutputStream2.write(array34);
                                                            ...
                                                            final String trim = string3.substring(n143, endIndex).trim();
                                                            n143 = endIndex + 1;
                        ...
                        while ((line8 = dataInputStream3.readLine()) != null) {
                            ...
                            while (true) {
                                while (n146 != 0) {
                                    ...
                                    final String svalue = this.getSvalue("mystages", string6, n145);
                                    if (!svalue.equals("")) {
            ...
            this.rd.setFont(new Font("Arial", 1, 13));
            this.ftm = this.rd.getFontMetrics();
            final String[] array35 = { "Stage", "Build", "View & Edit", "Publish" };
            final int[] array36 = { 0, 0, 100, 90 };
            final int[] array37 = { 0, 25, 25, 0 };
            int n147 = 4;
            Label_44107: {
                if (!this.stagename.equals("")) {
                    if (this.sfase == 0) {
            ...
            for (int tab = 0; tab < n147; ++tab) {
                this.rd.setColor(new Color(170, 170, 170));
                if (this.xm > array36[0]) {
                    if (this.xm < array36[3]) {
                        if (this.ym > 0) {
                            if (this.ym < 25) {
                                this.rd.setColor(new Color(200, 200, 200));
                            }
                ...
                this.rd.fillPolygon(array36, array37, 4);
                this.rd.setColor(new Color(0, 0, 0));
                this.rd.drawString(array35[tab], tab * 100 + 45 - this.ftm.stringWidth(array35[tab]) / 2, 17);
                if (this.xm > array36[0]) {
                    if (this.xm < array36[3]) {
                        if (this.ym > 0) {
                            if (this.ym < 25) {
                ...
                for (int n148 = 0; n148 < 4; ++n148) {
                    final int[] array38 = array36;
                    final int n149 = n148;
                    array38[n149] += 100;
                }
            }
            ...
            catch (final InterruptedException ex14) {}
        }
        this.track.unload();
        this.track = null;
        this.rd.dispose();
    ...
    public void removesp() {
        ...
        int index2 = -1;
        final int index3 = this.bstage.indexOf("set", beginIndex);
        if (index3 != -1) {
            index2 = index3;
        }
        final int index4 = this.bstage.indexOf("chk", beginIndex);
        if (index4 != -1 && index4 < index2) {
            index2 = index4;
        }
        final int index5 = this.bstage.indexOf("fix", beginIndex);
        ...
        if (index != -1) {
            this.bstage = "" + this.bstage.substring(0, index) + "" + this.bstage.substring(beginIndex, this.bstage.length()) + "";
        }
        this.readstage(0);
    }
    ...
    public void sortstage() {
        ...
        final int m = n47 - n50;
        final int i2 = n48 + n50;
        final int n51 = m + 2400;
        final int n52 = n45 - 0;
        final int n53 = n43 + 0;
        final int n54 = (int)((n53 - n52) / 4800.0f) + 1;
        final int n55 = (n54 * 4800 - (n53 - n52)) / 2;
        final int i3 = n52 - n55;
        final int i4 = n53 + n55;
        final int n56 = i3 + 2400;
    ...
    public void renstage(final String str) {
        if (str.equals("")) {
            JOptionPane.showMessageDialog(null, "Please Enter a New Stage Name!\n", "Stage Maker", 1);
        }
        else {
            try {
                if (new File("" + Madness.fpath + "mystages/" + this.stagename + ".txt").renameTo(new File("" + Madness.fpath + "mystages/" + str + ".txt"))) {
                    this.stagename = str;
                    this.sfase = 0;
                    this.hidefields();
                    this.tabed = -2;
                    ...
                    JOptionPane.showMessageDialog(null, "Unable to rename stage to: '" + str + "', possible reason: stage name already used!\n", "Stage Maker", 1);
                }
            }
            catch (final Exception obj) {
    ...
    public void delstage(final String str) {
        try {
            new File("" + Madness.fpath + "mystages/" + str + ".txt").delete();
            this.slstage.remove(str);
            this.slstage.select(0);
        }
        catch (final Exception obj) {
    ...
    public void fixtext(final TextField textField) {
        ...
        while (i < replace.length()) {
            ...
            if (string2.equals("|") || string2.equals(",") || string2.equals("(") || string2.equals(")") || string2.equals("#") || string2.equals(anObject) || string2.equals("!") || string2.equals("?") || string2.equals("~") || string2.equals(".") || string2.equals("@") || string2.equals("$") || string2.equals("%") || string2.equals("^") || string2.equals("&") || string2.equals("*") || string2.equals("+") || string2.equals("=") || string2.equals(">") || string2.equals("<") || string2.equals("/") || string2.equals(";") || string2.equals(":") || this.ftm.stringWidth(string) > 274) {
                n = i;
            }
            else {
                string += string2;
    ...
    public boolean button(final String str, final int n, final int n2, final int n3, final boolean b) {
        this.rd.setFont(new Font("Arial", 1, 12));
        this.ftm = this.rd.getFontMetrics();
        final int stringWidth = this.ftm.stringWidth(str);
        boolean b2 = false;
        if (str.equals(" Cancel ") && this.epart && Math.abs(this.xm - n) < stringWidth / 2 + 12 && Math.abs(this.ym - n2 + 5) < 10) {
            this.overcan = true;
        }
        ...
        if (!b3) {
            ...
            this.rd.drawLine(n - stringWidth / 2 - 12, n2 - (16 - n3), n - stringWidth / 2 - 12, n2 + (6 - n3));
            this.rd.setColor(new Color(0, 0, 0));
            if (str.equals("  Keyboard Controls  ")) {
