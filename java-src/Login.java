...
public class Login implements Runnable
{
            ...
            if (this.srvtrn < this.nservers) {
                while (this.serverdone[this.srvtrn] < this.xt.cntptrys) {
                    ...
                    try {
                        ...
                        final DatagramPacket datagramPacket = new DatagramPacket(buf, buf.length, this.IPAddress[this.srvtrn], 7000);
        ...
        if (this.fase == 16 || this.fase == 17) {
            ...
            while ((this.fase == 16 || this.fase == 17) && n3 != 3) {
                ...
                if (n3 != 3) {
                    ...
                    catch (final InterruptedException ex13) {}
                }
            }
            try {
                this.socket.close();
    ...
    public void multimode(final ContO[] array) {
        ...
        float alpha = 1.0f - (this.flipo - 10) / 80.0f;
        if (alpha > 1.0f) {
            alpha = 1.0f;
        }
        if (alpha < 0.0f) {
            ...
            for (int j = 0; j < array[this.xt.sc[0]].npl; ++j) {
                for (int k = 0; k < array[this.xt.sc[0]].p[j].n; ++k) {
                    if (array[this.xt.sc[0]].p[j].oz[k] < n2) {
                        n2 = array[this.xt.sc[0]].p[j].oz[k];
                    }
                    if (array[this.xt.sc[0]].p[j].oz[k] > n3) {
                        n3 = array[this.xt.sc[0]].p[j].oz[k];
                    }
                    if (array[this.xt.sc[0]].p[j].oy[k] < n4) {
                        n4 = array[this.xt.sc[0]].p[j].oy[k];
                    }
            ...
            if (this.trans >= 40) {
                ...
                if (this.fase == 14) {
                    ...
                    if (n6 != this.nservers) {
                        boolean b = false;
                        int n7 = 0;
                        for (int n8 = 0; n8 < this.nservers; ++n8) {
                            this.rd.setColor(new Color(0, 0, 0));
                            if (this.opselect == n8) {
                                this.rd.setColor(new Color(98, 56, 0));
                                this.rd.fillRoundRect(175, 230 + n8 * 20, 450, 20, 14, 14);
                                this.rd.setColor(new Color(0, 0, 0));
                                this.rd.drawRoundRect(175, 230 + n8 * 20, 450, 20, 14, 14);
                                this.rd.setColor(this.color2k(255, 255, 255));
                                if (this.xt.delays[n8] >= 400) {
                                    this.msg = "Your connection to this server is too slow!";
                                    n7 = 1;
                                }
                                if (this.xt.delays[n8] == 600) {
                                    this.msg = "This server is not responding!";
                                    n7 = 1;
                                }
                                if (this.xt.delays[n8] < 400) {
                                    for (int n9 = 0; n9 < this.nservers; ++n9) {
                                        if (this.xt.delays[n9] < this.xt.delays[n8] && n8 != n9) {
                                            b = true;
                                        }
                                    }
                                    if (b) {
                                    ...
                                    else if (this.xt.delays[n8] >= 300) {
                                        this.msg = "Your connection speed is not perfect.  You may encounter delay!";
                                    }
                                }
                            }
                            this.rd.drawString("Server Name :", 195, 245 + n8 * 20);
                            this.rd.drawString("|   Delay/Speed :", 385, 245 + n8 * 20);
                            int r = 0;
                            int g = 0;
                            String str = "" + this.xt.delays[n8] + "/";
                            if (this.xt.delays[n8] < 75) {
                                str += "EXCELENT *****";
                                r = 62;
                                g = 100;
                            }
                            if (this.xt.delays[n8] >= 75 && this.xt.delays[n8] < 150) {
                                str += "Perfect ****";
                                r = 62;
                                g = 100;
                            }
                            if (this.xt.delays[n8] >= 150 && this.xt.delays[n8] < 250) {
                                str += "Good ***";
                                r = 81;
                                g = 100;
                            }
                            if (this.xt.delays[n8] >= 250 && this.xt.delays[n8] < 400) {
                                str += "Acceptable **";
                                r = 100;
                                g = 100;
                            }
                            if (this.xt.delays[n8] >= 400 && this.xt.delays[n8] < 600) {
                                str += "Poor";
                                r = 100;
                                g = 0;
                            }
                            ...
                            this.rd.setColor(new Color(r, g, 0));
                            this.rd.drawString("" + this.snames[n8] + "", 294, 245 + n8 * 20);
                            this.rd.drawString(str, 497, 245 + n8 * 20);
                        }
                        if (!this.xt.logged && this.xt.nfreeplays - this.xt.ndisco >= 5 && n7 == 0) {
                ...
                if (this.fase == 17) {
                    ...
                    for (int n11 = 0; n11 < 5; ++n11) {
                        if (this.opselect == n11) {
                            this.rd.setColor(new Color(98, 56, 0));
                            this.rd.fillRoundRect(300, 230 + n11 * 20 + n10, 200, 20, 14, 14);
                            this.rd.setColor(new Color(0, 0, 0));
                            this.rd.drawRoundRect(300, 230 + n11 * 20 + n10, 200, 20, 14, 14);
                            this.rd.setColor(this.color2k(255, 255, 255));
                        }
                        this.rd.drawString("Room " + (n11 + 1) + " :", 329, 245 + n11 * 20 + n10);
                        this.rd.drawString("" + this.rmps[n11] + "  Players", 471 - this.ftm.stringWidth("" + this.rmps[n11] + "  Players"), 245 + n11 * 20 + n10);
                        if (n11 == this.recom) {
                            if (this.opselect != n11) {
    ...
    public void multistart(final ContO[] array, final int oxm, final int oym, final boolean b) {
        ...
        this.rd.drawImage(this.xt.dude[n2], 87, 76, null);
        this.rd.setComposite(AlphaComposite.getInstance(3, 1.0f));
            ...
            if (n2 == 2) {
                ...
                if (this.nflk == 0) {
                    ...
                    while (index < text.length()) {
                        final String string = "" + text.charAt(index);
                        if (string.equals("@") && n4 == 0 && index != 0) {
                            n4 = 1;
                        }
                        if (string.equals(".") && n4 == 1 && index != text.length() - 1) {
                            n4 = 2;
                        }
                        ++index;
                    }
    ...
    public void fixtext(final TextField textField) {
        ...
        while (i < replace.length()) {
            ...
            if (string2.equals("|") || string2.equals(",") || string2.equals("(") || string2.equals(")") || string2.equals("#") || string2.equals(anObject) || string2.equals("!") || string2.equals("?") || string2.equals(" ") || string2.equals("~") || string2.equals("$") || string2.equals("%") || string2.equals("^") || string2.equals("&") || string2.equals("*") || string2.equals("+") || string2.equals("=") || string2.equals(">") || string2.equals("<") || string2.equals("/") || string2.equals("'") || string2.equals(";") || string2.equals(":") || string2.equals(" ")) {
                n = i;
            }
            else {
                string += string2;
