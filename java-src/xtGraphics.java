...
public class xtGraphics extends Panel implements Runnable
{
    ...
    public xtGraphics(final Medium m, final CarDefine cd, final Graphics2D rd, final GameSparker app) {
        ...
        if (securityManager != null) {
            try {
                ...
                if (("" + obj).indexOf("access denied") != -1) {
                    this.nofull = true;
                }
            }
        }
            ...
            for (ZipEntry zipEntry = zipInputStream.getNextEntry(); zipEntry != null; zipEntry = zipInputStream.getNextEntry()) {
                ...
                for (int l = 0; l < 6; ++l) {
                    if (name.equals("air" + l + ".wav")) {
                        this.air[l] = new soundClip(b);
                    }
                }
                for (int n = 0; n < 3; ++n) {
                    if (name.equals("crash" + (n + 1) + ".wav")) {
                        this.crash[n] = new soundClip(b);
                    }
                }
                for (int n2 = 0; n2 < 3; ++n2) {
                    if (name.equals("lowcrash" + (n2 + 1) + ".wav")) {
                        this.lowcrash[n2] = new soundClip(b);
                    }
                }
                for (int n3 = 0; n3 < 3; ++n3) {
                    if (name.equals("skid" + (n3 + 1) + ".wav")) {
                        this.skid[n3] = new soundClip(b);
                    }
                }
                for (int n4 = 0; n4 < 3; ++n4) {
                    if (name.equals("dustskid" + (n4 + 1) + ".wav")) {
                        this.dustskid[n4] = new soundClip(b);
                    }
                }
                for (int n5 = 0; n5 < 3; ++n5) {
                    if (name.equals("scrape" + (n5 + 1) + ".wav")) {
                        this.scrape[n5] = new soundClip(b);
                        if (n5 == 2) {
                            this.scrape[3] = new soundClip(b);
                        }
                    }
                }
                if (name.equals("powerup.wav")) {
                    this.powerup = new soundClip(b);
                }
                if (name.equals("tires.wav")) {
                    this.tires = new soundClip(b);
                }
                if (name.equals("checkpoint.wav")) {
                    this.checkpoint = new soundClip(b);
                }
                if (name.equals("carfixed.wav")) {
                    this.carfixed = new soundClip(b);
                }
                if (name.equals("three.wav")) {
                    this.three = new soundClip(b);
                }
                if (name.equals("two.wav")) {
                    this.two = new soundClip(b);
                }
                if (name.equals("one.wav")) {
                    this.one = new soundClip(b);
                }
                if (name.equals("go.wav")) {
                    this.go = new soundClip(b);
                }
                if (name.equals("wasted.wav")) {
                    this.wastd = new soundClip(b);
                }
                if (name.equals("firewasted.wav")) {
                    this.firewasted = new soundClip(b);
                }
                this.dnload += 5;
            }
            in.close();
    ...
    public void run() {
        ...
        while ((this.runtyp == -101 || this.sendstat == 1) && !this.lan) {
            ...
            String x;
            if (this.clanchat) {
                x = string + "" + this.updatec[1] + "|" + this.clan + "|" + this.clankey + "|";
            }
            else {
                x = string + "0|||";
            }
            if (this.updatec[0] <= -11) {
                for (int i = 0; i < -this.updatec[0] - 10; ++i) {
                    x = x + "" + this.cnames[0][6 - i] + "|" + this.sentn[0][6 - i] + "|";
                }
                this.updatec[0] = -2;
            }
            if (this.clanchat && this.updatec[1] <= -11) {
                for (int j = 0; j < -this.updatec[1] - 10; ++j) {
                    x = x + "" + this.cnames[1][6 - j] + "|" + this.sentn[1][6 - j] + "|";
                }
                this.updatec[1] = -2;
            }
            if (this.sendstat == 1) {
                x = "5|" + this.playingame + "|" + this.im + "|" + this.beststunt + "|" + this.fastestlap + "|";
            ...
            if (n != 0) {
                ...
                try {
                    ...
                    (this.dout = new PrintWriter(this.socket.getOutputStream(), true)).println(x);
                    s = this.din.readLine();
                    if (s != null) {
                        n = 0;
                    }
            ...
            if (this.sendstat != 2) {
                ...
                for (int l = 0; l < n3; ++l) {
                    final int getvalue = this.getvalue(s, l);
                    if (this.updatec[l] != getvalue && this.updatec[l] >= -2 && this.pointc[l] == 6) {
                        for (int n4 = 0; n4 < 7; ++n4) {
                            this.cnames[l][n4] = this.getSvalue(s, n2);
                            ++n2;
                            this.sentn[l][n4] = this.getSvalue(s, n2);
                            ++n2;
                        }
        ...
        if (this.testdrive != 3 && this.testdrive != 4) {
            ...
            if (this.gmode == 0) {
                ...
                if (this.nfmtab == 3 || this.nfmtab == 4) {
                    ...
                    if (beginIndex > 0) {
                        substring = this.app.mstgs.getSelectedItem().substring(beginIndex);
                    }
    ...
    public void hipnoload(final int n, final boolean b) {
        ...
        int r = (int)(230.0f - 230.0f * (array[0] / 100.0f));
        if (r > 255) {
            r = 255;
        }
        if (r < 0) {
        ...
        int g = (int)(230.0f - 230.0f * (array[1] / 100.0f));
        if (g > 255) {
            g = 255;
        }
        if (g < 0) {
        ...
        int b2 = (int)(230.0f - 230.0f * (array[2] / 100.0f));
        if (b2 > 255) {
            b2 = 255;
        }
        if (b2 < 0) {
        ...
        if (n3 == 0) {
            ...
            int g2 = (int)(80.0f - 80.0f * (array[1] / 100.0f));
            if (g2 > 255) {
                g2 = 255;
            }
            if (g2 < 0) {
            ...
            int b3 = (int)(80.0f - 80.0f * (array[2] / 100.0f));
            if (b3 > 255) {
                b3 = 255;
            }
            if (b3 < 0) {
            ...
            this.rd.setColor(new Color(r2, g2, b3));
            this.rd.setFont(new Font("Arial", 1, 13));
            if (this.multion != 0) {
                ...
                if (n == 10 && this.ransay != 4) {
                    if (this.tflk) {
                        this.rd.setColor(new Color(200, g2, b3));
                        this.tflk = false;
                    }
                    else {
                        this.tflk = true;
        ...
        if (!b) {
            this.drawcs(340 + n3, "" + this.sndsize[n4] + " KB", 0, 0, 0, 3);
            this.drawcs(375 + n3, " Please Wait...", 0, 0, 0, 3);
        }
        else {
            ...
            if (this.multion != 0) {
                this.drawcs(380 + n3, "" + this.forstart / 20, 0, 0, 0, 3);
            }
        }
    }
    ...
    public void loadstrack(final int n, final String str, final int n2) {
        if (n == 1) {
        ...
        if (n < 0) {
            if (!str.equals("")) {
                if (n != -2) {
                    this.strack = new RadicalMod("mystages/mymusic/" + str + ".zip", n2, 8000, 125, false, false);
                }
                else {
                    this.strack = new RadicalMod(str, n2, 8000, 125, false, true);
                }
            }
            else {
    ...
    public void multistat(final Control control, final CheckPoints checkPoints, final int lxm, final int lym, final boolean b, final UDPMistro udpMistro) {
        ...
        if (this.fase != -2) {
            if (this.exitm != 0 && !this.holdit) {
                if (!this.lan || this.im != 0) {
                    ...
                    Color.RGBtoHSB(this.m.cgrnd[0], this.m.cgrnd[1], this.m.cgrnd[2], hsbvals);
                    ...
                    final float[] array2 = hsbvals;
                    final int n3 = 2;
                    array2[n3] += (float)0.15;
                    if (hsbvals[2] > 1.0f) {
                        hsbvals[2] = 1.0f;
                    }
                    this.rd.setColor(Color.getHSBColor(hsbvals[0], hsbvals[1], hsbvals[2]));
                    this.rd.fillRect(357, 169, 39, 10);
                    this.rd.fillRect(403, 169, 39, 10);
                    final float[] array3 = hsbvals;
                    final int n4 = 1;
                    array3[n4] -= (float)0.07;
                    if (hsbvals[1] < 0.0f) {
                        hsbvals[1] = 0.0f;
                    }
                    final float[] array4 = hsbvals;
                    final int n5 = 2;
                    array4[n5] += (float)0.07;
                    if (hsbvals[2] > 1.0f) {
                        hsbvals[2] = 1.0f;
                    }
                    this.rd.setColor(Color.getHSBColor(hsbvals[0], hsbvals[1], hsbvals[2]));
                ...
                Color.RGBtoHSB(this.m.cgrnd[0], this.m.cgrnd[1], this.m.cgrnd[2], hsbvals2);
                final float[] array5 = hsbvals2;
                final int n7 = 1;
                array5[n7] -= (float)0.15;
                if (hsbvals2[1] < 0.0f) {
                    hsbvals2[1] = 0.0f;
                }
                final float[] array6 = hsbvals2;
                final int n8 = 2;
                array6[n8] += (float)0.15;
                if (hsbvals2[2] > 1.0f) {
                    hsbvals2[2] = 1.0f;
                }
                this.rd.setColor(Color.getHSBColor(hsbvals2[0], hsbvals2[1], hsbvals2[2]));
                this.rd.fillRect(357, 369, 39, 10);
                if (!this.lan || this.im != 0) {
                    this.rd.fillRect(403, 369, 39, 10);
                }
                final float[] array7 = hsbvals2;
                final int n9 = 1;
                array7[n9] -= (float)0.07;
                if (hsbvals2[1] < 0.0f) {
                    hsbvals2[1] = 0.0f;
                }
                final float[] array8 = hsbvals2;
                final int n10 = 2;
                array8[n10] += (float)0.07;
                if (hsbvals2[2] > 1.0f) {
                    hsbvals2[2] = 1.0f;
                }
                this.rd.setColor(Color.getHSBColor(hsbvals2[0], hsbvals2[1], hsbvals2[2]));
                ...
                if (this.warning == 0 || this.warning == 210) {
                    ...
                    for (int i = n11; i >= 0; --i) {
                        ...
                        if (b2 || this.floater[i] != 0 || control.chatup == i + 1 || this.msgflk[i] != 0) {
                            ...
                            Color.RGBtoHSB(this.m.cgrnd[0], this.m.cgrnd[1], this.m.cgrnd[2], hsbvals3);
                            final float[] array9 = hsbvals3;
                            final int n16 = 1;
                            array9[n16] -= (float)0.15;
                            if (hsbvals3[1] < 0.0f) {
                                hsbvals3[1] = 0.0f;
                            }
                            final float[] array10 = hsbvals3;
                            final int n17 = 2;
                            array10[n17] += (float)0.15;
                            if (hsbvals3[2] > 1.0f) {
                                hsbvals3[2] = 1.0f;
                            }
                            this.rd.setColor(Color.getHSBColor(hsbvals3[0], hsbvals3[1], hsbvals3[2]));
                                ...
                                while (n23 >= 0) {
                                    ...
                                    if (this.ftm.stringWidth(this.cnames[i][n23] + ": ") + 39 + n18 < 775) {
                                        ...
                                        if (this.ftm.stringWidth(this.sentn[i][n23]) + 39 + n25 < 775) {
                                            ...
                                            String string3 = "";
                                            for (int index = 0; this.ftm.stringWidth(string3) + 39 + n25 < 775 && index < this.sentn[i][n23].length(); string3 += this.sentn[i][n23].charAt(index), ++index) {}
                                        ...
                                        String string5 = "";
                                        for (int index2 = 0; this.ftm.stringWidth(string5) + 39 + n18 < 775 && index2 < this.cnames[i][n23].length(); string5 += this.cnames[i][n23].charAt(index2), ++index2) {}
                        ...
                        if (b2 || this.floater[i] != 0) {
                            ...
                            Color.RGBtoHSB(this.m.cgrnd[0], this.m.cgrnd[1], this.m.cgrnd[2], hsbvals4);
                            final float[] array11 = hsbvals4;
                            final int n26 = 1;
                            array11[n26] -= (float)0.076;
                            if (hsbvals4[1] < 0.0f) {
                                hsbvals4[1] = 0.0f;
                            }
                            final float[] array12 = hsbvals4;
                            final int n27 = 2;
                            array12[n27] += (float)0.076;
                            if (hsbvals4[2] > 1.0f) {
                                hsbvals4[2] = 1.0f;
                            }
                            this.rd.setColor(Color.getHSBColor(hsbvals4[0], hsbvals4[1], hsbvals4[2]));
            ...
            if ((control.arrace && this.starcnt < 38 && !this.holdit && checkPoints.stage != 10) || this.multion >= 2) {
                ...
                if (this.multion >= 2) {
                    if (this.alocked == -1 || this.holdit) {
                        if (this.cntflock == 100) {
                            for (int n28 = 0; n28 < this.nplayers; ++n28) {
                                if (this.holdit) {
                                    if (checkPoints.pos[n28] == 0) {
                                        this.alocked = n28;
                                        this.im = n28;
                                    }
                                }
                                else if (checkPoints.dested[n28] == 0) {
                                    this.alocked = n28;
                                    this.im = n28;
                                }
                            }
                    ...
                    if (this.lan) {
                        boolean b4 = true;
                        for (int n29 = 0; n29 < this.nplayers; ++n29) {
                            if (this.dested[n29] == 0 && this.plnames[n29].indexOf("MadBot") == -1) {
                                b4 = false;
                            }
                        }
                        if (b4) {
                ...
                for (int nplayers = this.nplayers, n30 = 0; n30 < nplayers; ++n30) {
                    int n31 = 0;
                    for (int n32 = 0; n32 < this.nplayers; ++n32) {
                        if (checkPoints.pos[n32] == n30 && checkPoints.dested[n32] == 0 && n31 == 0) {
                            int b5 = (int)(100.0f + 100.0f * (this.m.snap[2] / 100.0f));
                            if (b5 > 255) {
                                b5 = 255;
                            }
                            if (b5 < 0) {
                            ...
                            this.rd.setColor(new Color(0, 0, b5));
                            if (n30 == 0) {
                                this.rd.drawString("1st", 673, 76 + 30 * n30);
                            }
                            if (n30 == 1) {
                                this.rd.drawString("2nd", 671, 76 + 30 * n30);
                            }
                            if (n30 == 2) {
                                this.rd.drawString("3rd", 671, 76 + 30 * n30);
                            }
                            if (n30 >= 3) {
                                this.rd.drawString("" + (n30 + 1) + "th", 671, 76 + 30 * n30);
                            }
                            if (this.clangame != 0) {
                                int n33;
                                int n34;
                                int n35;
                                if (this.pclan[n32].toLowerCase().equals(this.gaclan.toLowerCase())) {
                                    n33 = 255;
                                    n34 = 128;
                                    n35 = 0;
                                }
                                ...
                                int r = (int)(n33 + n33 * (this.m.snap[0] / 100.0f));
                                if (r > 255) {
                                    r = 255;
                                }
                                if (r < 0) {
                                ...
                                int g = (int)(n34 + n34 * (this.m.snap[1] / 100.0f));
                                if (g > 255) {
                                    g = 255;
                                }
                                if (g < 0) {
                                ...
                                int b6 = (int)(n35 + n35 * (this.m.snap[2] / 100.0f));
                                if (b6 > 255) {
                                    b6 = 255;
                                }
                                if (b6 < 0) {
                            ...
                            final int n39 = 11;
                            if (n36 > 20) {
                                n38 = (int)(244.0f - 233.0f * ((n36 - 20) / 40.0f));
                            }
                            int r2 = (int)(n37 + n37 * (this.m.snap[0] / 100.0f));
                            if (r2 > 255) {
                                r2 = 255;
                            }
                            if (r2 < 0) {
                            ...
                            int g2 = (int)(n38 + n38 * (this.m.snap[1] / 100.0f));
                            if (g2 > 255) {
                                g2 = 255;
                            }
                            if (g2 < 0) {
                            ...
                            int b7 = (int)(n39 + n39 * (this.m.snap[2] / 100.0f));
                            if (b7 > 255) {
                                b7 = 255;
                            }
                            if (b7 < 0) {
                            ...
                            if ((this.im != n32 || this.multion >= 2) && lxm > 661 && lxm < 775 && lym > 58 + 30 * n30 && lym < 83 + 30 * n30) {
                                ...
                                if (b) {
                                    if (!this.onlock) {
                                        if (this.alocked != n32 || this.multion >= 2) {
                                            this.alocked = n32;
                                            if (this.multion >= 2) {
                                                this.im = n32;
                                            }
                            ...
                            if (this.alocked == n32) {
                                ...
                                int b9 = (int)(255.0f + 255.0f * (this.m.snap[2] / 100.0f));
                                if (b9 > 255) {
                                    b9 = 255;
                                }
                                if (b9 < 0) {
                                ...
                                this.rd.setColor(new Color(r3, g3, b9));
                                this.rd.drawRect(661, 58 + 30 * n30, 114, 25);
                                this.rd.drawRect(662, 59 + 30 * n30, 112, 23);
                            }
                            if (b8 && !this.onlock) {
                                int r4;
                                int g4;
                                int b10;
                                if (this.alocked == n32) {
                                    r4 = (int)(120.0f + 120.0f * (this.m.snap[0] / 100.0f));
                                    if (r4 > 255) {
                                        r4 = 255;
                                    }
                                    if (r4 < 0) {
                                    ...
                                    g4 = (int)(114.0f + 114.0f * (this.m.snap[1] / 100.0f));
                                    if (g4 > 255) {
                                        g4 = 255;
                                    }
                                    if (g4 < 0) {
                                    ...
                                    b10 = (int)(255.0f + 255.0f * (this.m.snap[2] / 100.0f));
                                    if (b10 > 255) {
                                        b10 = 255;
                                    }
                                    if (b10 < 0) {
                                    ...
                                    r4 = (int)(140.0f + 140.0f * (this.m.snap[0] / 100.0f));
                                    if (r4 > 255) {
                                        r4 = 255;
                                    }
                                    if (r4 < 0) {
                                    ...
                                    g4 = (int)(160.0f + 160.0f * (this.m.snap[1] / 100.0f));
                                    if (g4 > 255) {
                                        g4 = 255;
                                    }
                                    if (g4 < 0) {
                                ...
                                this.rd.setColor(new Color(r4, g4, b10));
                                this.rd.drawRect(660, 57 + 30 * n30, 116, 27);
                            }
                            n31 = 1;
                        }
                    }
            ...
            if (udpMistro.go && udpMistro.runon == 1 && !this.holdit) {
                int n40 = 0;
                int n41 = 0;
                for (int n42 = 0; n42 < this.nplayers; ++n42) {
                    if (n42 != udpMistro.im) {
                        ++n41;
                        if (udpMistro.lframe[n42] == udpMistro.lcframe[n42] || udpMistro.force[n42] == 7) {
                            ++n40;
                        }
                        else {
                            udpMistro.lcframe[n42] = udpMistro.lframe[n42];
                        }
                    }
                }
                if (n40 == n41) {
        ...
        if (n != -1) {
            final float[] hsbvals5 = new float[3];
            Color.RGBtoHSB(this.m.cgrnd[0], this.m.cgrnd[1], this.m.cgrnd[2], hsbvals5);
            final float[] array13 = hsbvals5;
            final int n43 = 1;
            array13[n43] -= (float)0.22;
            if (hsbvals5[1] < 0.0f) {
                hsbvals5[1] = 0.0f;
            }
            final float[] array14 = hsbvals5;
            final int n44 = 2;
            array14[n44] += (float)0.22;
            if (hsbvals5[2] > 1.0f) {
                hsbvals5[2] = 1.0f;
            }
                ...
                if (this.flatrstart == 6) {
                    if (this.cfase == 10) {
                        ...
                        if (this.cd.action == 12) {
                            ...
                            String str = "Top 20 Cars";
                            String s3 = "Weekly";
                            while (loadlist > 6) {
                                loadlist -= 6;
                                if (s3.equals("Semi-Annual")) {
                                    s3 = "Annual";
                                }
                            ...
                            if (loadlist == 2) {
                                str = "" + s3 + " Top 20 Class A Cars";
                            }
                            if (loadlist == 3) {
                                str = "" + s3 + " Top 20 Class A & B Cars";
                            }
                            if (loadlist == 4) {
                                str = "" + s3 + " Top 20 Class B Cars";
                            }
                            if (loadlist == 5) {
                                str = "" + s3 + " Top 20 Class B & C Cars";
                            }
                            if (loadlist == 6) {
                                str = "" + s3 + " Top 20 Class C Cars";
                            }
                            this.drawprom(145, 170);
                            this.drawcs(195, "[  Loading " + str + "  ]", 0, 0, 0, 3);
                    ...
                    if (this.cfase == 3 && n7 == -1) {
                        ...
                        if (this.noclass) {
                            ...
                            this.drawcs(230, "You do not have a " + str2 + " car in your account cars.", 0, 0, 0, 3);
                    ...
                    if (this.multion != 0 || this.testdrive == 1 || this.testdrive == 2) {
                        ...
                        if (this.cfase != 10 || (this.cd.action != 0 && this.cd.action < 14)) {
                            this.rd.drawString(str3, 549 - this.ftm.stringWidth(str3) / 2, 95);
                        }
                        this.rd.setFont(new Font("Arial", 1, 12));
                        this.ftm = this.rd.getFontMetrics();
                        this.rd.setColor(new Color(0, 0, 0));
                        ...
                        for (int n25 = 0; n25 < 161; ++n25) {
                            this.rd.setColor(Color.getHSBColor((float)((float)n25 * 0.00625), 1.0f, 1.0f));
                            this.rd.drawLine(102, 75 + n25, 110, 75 + n25);
                            if (n25 <= 128) {
                                this.rd.setColor(Color.getHSBColor(1.0f, 0.0f, (float)(1.0 - (float)n25 * 0.00625)));
                        ...
                        for (int n26 = 0; n26 < 40; ++n26) {
                            this.rd.setColor(Color.getHSBColor(this.arnp[0], (float)((float)n26 * 0.025), 1.0f - this.arnp[2]));
                            this.rd.drawLine(121 + n26, 224, 121 + n26, 230);
                            this.rd.setColor(Color.getHSBColor(this.arnp[3], (float)((float)n26 * 0.025), 1.0f - this.arnp[5]));
    ...
    public boolean clink(final String str, final int n, final int n2, final boolean b) {
        boolean b2 = false;
        this.rd.drawString("Created by :  " + str + "", 241, 160);
        final int stringWidth = this.ftm.stringWidth(str);
        final int n3 = 241 + this.ftm.stringWidth("Created by :  " + str + "") - stringWidth;
        ...
        if (this.fase != -2) {
            ...
            if (this.clangame != 0 && (!mad.dest || this.multion >= 2)) {
                ...
                for (int i = 0; i < this.nplayers; ++i) {
                    if (checkPoints.dested[i] == 0) {
                        ...
                        else if (!str.toLowerCase().equals(this.pclan[i].toLowerCase())) {
                            b2 = false;
                            break;
                        }
                    }
            ...
            if (this.clangame > 1) {
                ...
                if (b2) {
                    for (int j = 0; j < this.nplayers; ++j) {
                        if (!str.toLowerCase().equals(this.pclan[j].toLowerCase())) {
                            str2 = this.pclan[j];
                            break;
                        }
                    }
                    ...
                    if (this.clangame == 4 && !str.toLowerCase().equals(this.gaclan.toLowerCase())) {
                        b3 = true;
                        s = "Clan " + str2 + " wasted, nobody won becuase " + str + " should have raced in this racing vs wasting game!";
                    }
                    if (this.clangame == 5 && str.toLowerCase().equals(this.gaclan.toLowerCase())) {
                        b3 = true;
                        s = "Clan " + str2 + " wasted, nobody won becuase " + str + " should have raced in this racing vs wasting game!";
                    }
                }
            ...
            if (b) {
                ...
                if (this.m.darksky) {
                    ...
                    final float[] hsbvals = new float[3];
                    Color.RGBtoHSB(this.m.csky[0], this.m.csky[1], this.m.csky[2], hsbvals);
                    hsbvals[2] = 0.6f;
                    this.rd.setColor(Color.getHSBColor(hsbvals[0], hsbvals[1], hsbvals[2]));
    ...
    public void drawhi(final Image image, final int n) {
        if (this.m.darksky) {
            ...
            Color.RGBtoHSB(this.m.csky[0], this.m.csky[1], this.m.csky[2], hsbvals);
            hsbvals[2] = 0.6f;
            final Color hsbColor = Color.getHSBColor(hsbvals[0], hsbvals[1], hsbvals[2]);
            this.rd.setColor(hsbColor);
    ...
    public void drawcs(final int n, final String str, int r, int g, int b, final int n2) {
        if (n2 != 3 && n2 != 4 && n2 != 5) {
        ...
        this.rd.setColor(new Color(r, g, b));
        this.rd.drawString(str, 400 - this.ftm.stringWidth(str) / 2, n);
    }
    ...
    public void arrow(final int n, final int n2, final CheckPoints checkPoints, final boolean b) {
        ...
        if (!b) {
            ...
            n7 = (int)(90 + n6 + Math.atan((checkPoints.z[n] - checkPoints.opz[this.im]) / (double)(checkPoints.x[n] - checkPoints.opx[this.im])) / 0.017453292519943295);
        }
        else {
            int alocked = 0;
        ...
        if (!b) {
            if (abs > 7 || n2 > 0 || n2 == -2 || this.cntan != 0) {
                ...
                if (n2 <= 0) {
                    ...
                    if (abs >= 90) {
                        int n10 = (int)(255.0f + 255.0f * (this.m.snap[0] / 100.0f));
                        if (n10 > 255) {
                            n10 = 255;
                        }
                        if (n10 < 0) {
            ...
            this.rd.setColor(new Color(r3, g3, b4));
            this.rd.fillPolygon(array, array2, 7);
    ...
    public void radarstat(final Mad mad, final ContO contO, final CheckPoints checkPoints) {
        ...
        int r = (int)(159.0f + 159.0f * (this.m.snap[0] / 100.0f));
        if (r > 255) {
            r = 255;
        }
        if (r < 0) {
        ...
        if (this.clangame != 0) {
            ...
            r = (int)(n9 + n9 * (this.m.snap[0] / 100.0f));
            if (r > 255) {
                r = 255;
            }
            if (r < 0) {
            ...
            g = (int)(n10 + n10 * (this.m.snap[1] / 100.0f));
            if (g > 255) {
                g = 255;
            }
            if (g < 0) {
            ...
            b2 = (int)(n11 + n11 * (this.m.snap[2] / 100.0f));
            if (b2 > 255) {
                b2 = 255;
            }
            if (b2 < 0) {
        ...
        this.rd.setColor(new Color((r + this.m.csky[0]) / 2, (this.m.csky[1] + g) / 2, (b2 + this.m.csky[2]) / 2));
        ...
        final int n12 = contO.x - this.lcarx;
        this.lcarx = contO.x;
        final int n13 = contO.y - this.lcary;
        this.lcary = contO.y;
        final int n14 = contO.z - this.lcarz;
        this.lcarz = contO.z;
        final float n15 = (float)Math.sqrt(n12 * n12 + n14 * n14) * 1.4f * 21.0f * 60.0f * 60.0f / 100000.0f;
        final float n16 = n15 * 0.621371f;
        this.rd.setColor(new Color(0, 0, 100));
        this.rd.drawString("" + (int)n15, 62, 245);
        this.rd.drawString("" + (int)n16, 132, 245);
    }
    ...
    public void fleximage(final Image img, final int n, final int n2) {
        if (!this.badmac) {
            ...
            for (int i = 0; i < 360000; ++i) {
                ...
                final int r = (int)((n6 * 17 + n7 + n8 + n4) / 21.0f);
                final int g = (int)((n7 * 17 + n6 + n8 + n4) / 22.0f);
                final int b = (int)((n8 * 17 + n6 + n7 + n4) / 24.0f);
                if (--n5 == 0) {
                    n4 = (int)(Math.random() * 128.0);
                    n5 = (int)(5.0 + Math.random() * 15.0);
                }
                this.flexpix[i] = new Color(r, g, b).getRGB();
            }
    ...
    private Image loadsnap(final Image img) {
        ...
        for (int i = 0; i < width * height; ++i) {
            ...
            if (color2.getRed() != color2.getGreen() && color2.getGreen() != color2.getBlue()) {
                ...
                int n4 = (int)((color.getRed() - color2.getRed()) / (float)color.getRed() * 255.0f);
                if (n4 > 255) {
                    n4 = 255;
                }
                if (n4 < 0) {
    ...
    private Image loadopsnap(final Image img, int n, final int n2) {
        final int height = img.getHeight(this.ob);
        final int width = img.getWidth(this.ob);
        final int[] array = new int[width * height];
        final PixelGrabber pixelGrabber = new PixelGrabber(img, 0, 0, width, height, array, 0, width);
        ...
        for (int j = 0; j < width * height; ++j) {
            if (array[j] != array[n2]) {
                ...
                if (n2 == 1 && array[j] == n3) {
                    ...
                    g = (int)(237.0f - 237.0f * (array2[1] / 150.0f));
                    if (g > 255) {
                        g = 255;
                    }
                    if (g < 0) {
                    ...
                    b = (int)(237.0f - 237.0f * (array2[2] / 150.0f));
                    if (b > 255) {
                        b = 255;
                    }
                    if (b < 0) {
                    ...
                    r = (int)(color.getRed() - color.getRed() * (array2[0] / 100.0f));
                    if (r > 255) {
                        r = 255;
                    }
                    if (r < 0) {
                    ...
                    g = (int)(color.getGreen() - color.getGreen() * (array2[1] / 100.0f));
                    if (g > 255) {
                        g = 255;
                    }
                    if (g < 0) {
                    ...
                    b = (int)(color.getBlue() - color.getBlue() * (array2[2] / 100.0f));
                    if (b > 255) {
                        b = 255;
                    }
                    if (b < 0) {
                ...
                array[j] = new Color(r, g, b).getRGB();
            }
        }
    ...
    public void pauseimage(final Image img) {
        if (!this.badmac) {
            final int[] array = new int[360000];
            final PixelGrabber pixelGrabber = new PixelGrabber(img, 0, 0, 800, 450, array, 0, 800);
            try {
                pixelGrabber.grabPixels();
            }
            catch (final InterruptedException ex) {}
            ...
            for (int i = 0; i < 360000; ++i) {
                ...
                if (i > 800 * (8 + n2) + 281 && n2 < 188) {
                    final int r = (n5 + 60) / 3;
                    final int g = (n5 + 135) / 3;
                    final int b = (n5 + 220) / 3;
                    if (++n == 237) {
                        ++n2;
                        n = 0;
                    }
    ...
    public void jflexo() {
        if (!this.badmac) {
            ...
            for (int i = 0; i < 360000; ++i) {
                ...
                if (n == 0) {
                    r = (red = color.getRed());
                    g = (green = color.getGreen());
                    b = (blue = color.getBlue());
                }
                else {
                    r = (red = (color.getRed() + red * 10) / 11);
                    g = (green = (color.getGreen() + green * 10) / 11);
                    b = (blue = (color.getBlue() + blue * 10) / 11);
                }
                if (++n == 800) {
                    n = 0;
                }
    ...
    public Image getImage(final String str) {
        final Image image = Toolkit.getDefaultToolkit().createImage("" + Madness.fpath + "" + str + "");
        final MediaTracker mediaTracker = new MediaTracker(this.app);
        mediaTracker.addImage(image, 0);
        try {
            mediaTracker.waitForID(0);
    ...
    private Image loadude(final byte[] imagedata, final MediaTracker mediaTracker, final Toolkit toolkit) {
        final Image image = toolkit.createImage(imagedata);
        mediaTracker.addImage(image, 0);
        try {
            mediaTracker.waitForID(0);
    ...
    private void smokeypix(final byte[] imagedata, final MediaTracker mediaTracker, final Toolkit toolkit) {
        final Image image = toolkit.createImage(imagedata);
        mediaTracker.addImage(image, 0);
        try {
            mediaTracker.waitForID(0);
        ...
        for (int i = 0; i < 94132; ++i) {
            if (this.smokey[i] != this.smokey[0]) {
                ...
                hsbvals[0] = 0.11f;
                hsbvals[1] = 0.45f;
                this.smokey[i] = Color.getHSBColor(hsbvals[0], hsbvals[1], hsbvals[2]).getRGB();
            }
        }
    }
                ...
                for (int j = 0; j < 202; ++j) {
                    if (this.smokey[i + j * 466] != this.smokey[0]) {
                        ...
                        if (i + n + 100 < 670 && i + n + 100 > 0 && j + n2 + 110 < 400 && j + n2 + 110 > 0 && n3 < 268000 && n3 >= 0) {
                            ...
                            int r = (int)((color.getRed() * (this.flang * n4) + color2.getRed() * (1.0f - n4)) / (this.flang * n4 + (1.0f - n4)));
                            int g = (int)((color.getGreen() * (this.flang * n5) + color2.getGreen() * (1.0f - n5)) / (this.flang * n5 + (1.0f - n5)));
                            int b = (int)((color.getBlue() * (this.flang * n6) + color2.getBlue() * (1.0f - n6)) / (this.flang * n6 + (1.0f - n6)));
                            if (r > 255) {
                                r = 255;
                            }
                            if (r < 0) {
    ...
    public boolean msgcheck(String lowerCase) {
        ...
        int n = 0;
        int n2;
        for (n2 = 0; index < lowerCase.length() && n2 == 0; ++index) {
            if (n == 0) {
                string = string + "" + lowerCase.charAt(index);
                n = 1;
            }
            else {
                n = 0;
                if (!string2.equals("") && !string2.equals("" + lowerCase.charAt(index))) {
                    n2 = 1;
                }
                string2 = "" + lowerCase.charAt(index);
            }
        }
        if (n2 == 0) {
        ...
        int n3 = 1;
        int n4;
        for (n4 = 0; index2 < lowerCase.length() && n4 == 0; ++index2) {
            if (n3 == 0) {
                string3 = string3 + "" + lowerCase.charAt(index2);
                n3 = 1;
            }
            else {
                n3 = 0;
                if (!string4.equals("") && !string4.equals("" + lowerCase.charAt(index2))) {
                    n4 = 1;
                }
                string4 = "" + lowerCase.charAt(index2);
            }
        }
        if (n4 == 0) {
        ...
        int n5 = 0;
        int n6;
        for (n6 = 0; index3 < lowerCase.length() && n6 == 0; ++index3) {
            if (n5 == 0) {
                string5 = string5 + "" + lowerCase.charAt(index3);
                n5 = 2;
            }
            else {
                --n5;
                if (!string6.equals("") && !string6.equals("" + lowerCase.charAt(index3))) {
                    n6 = 1;
                }
                string6 = "" + lowerCase.charAt(index3);
            }
        }
        if (n6 == 0) {
        ...
        int n7 = 1;
        int n8;
        for (n8 = 0; index4 < lowerCase.length() && n8 == 0; ++index4) {
            if (n7 == 0) {
                string7 = string7 + "" + lowerCase.charAt(index4);
                n7 = 2;
            }
            else {
                --n7;
                if (!string8.equals("") && !string8.equals("" + lowerCase.charAt(index4))) {
                    n8 = 1;
                }
                string8 = "" + lowerCase.charAt(index4);
            }
        }
        if (n8 == 0) {
            for (int n9 = 0; n9 < array.length; ++n9) {
                if (string7.indexOf(array[n9]) != -1) {
                    b = true;
                }
            }
        }
        ...
        int n10 = 2;
        int n11;
        for (n11 = 0; index5 < lowerCase.length() && n11 == 0; ++index5) {
            if (n10 == 0) {
                string9 = string9 + "" + lowerCase.charAt(index5);
                n10 = 2;
            }
            else {
                --n10;
                if (!string10.equals("") && !string10.equals("" + lowerCase.charAt(index5))) {
                    n11 = 1;
                }
                string10 = "" + lowerCase.charAt(index5);
            }
        }
        if (n11 == 0) {
            for (int n12 = 0; n12 < array.length; ++n12) {
                if (string9.indexOf(array[n12]) != -1) {
                    b = true;
                }
            }
        }
