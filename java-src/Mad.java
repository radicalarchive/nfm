...
public class Mad
{
    ...
    public void drive(final Control control, final ContO contO, final Trackers trackers, final CheckPoints checkPoints) {
        ...
        if (this.scy[3] != this.scy[2]) {
            ...
            if (a8 >= 0.9998) {
                ...
                a4 = (int)(Math.acos(a8) / 0.017453292519943295 * n105);
            }
        }
        if (b2) {
            int abs;
        ...
        for (int n113 = 0; n113 < checkPoints.n; ++n113) {
    ...
    public int regy(final int n, float a, final ContO contO) {
        int n2 = 0;
        boolean b = true;
        ...
        if (a > 100.0f) {
            ...
            if (n4 * n3 == 0) {
                this.shakedam = (int)((Math.abs(a) + this.shakedam) / 2.0f);
            }
            if (this.im == this.xt.im || this.colidim) {
                this.xt.crash(a, n4 * n3);
            }
    ...
    public void colide(final ContO contO, final Mad mad, final ContO contO2) {
        ...
        if (this.rpy((float)contO.x, (float)contO2.x, (float)contO.y, (float)contO2.y, (float)contO.z, (float)contO2.z) < (contO.maxR * contO.maxR + contO2.maxR * contO2.maxR) * 1.5) {
